...
- [x] 02.1-02-PLAN.md — Rasterizer &Mesh refactor + renderer_alloc bunny bench (Wave 2)
- [x] 02.1-03-PLAN.md — Model-viewer example + happyterminals::prelude re-exports (Wave 3)
...
- [x] 02.2-03-PLAN.md — 8-fixture insta snapshot matrix + color-test example + README §Terminal Color Support (Wave 3)
...
Plans:
- [x] 02.3-01-PLAN.md -- Input crate: core types, drag state machine, modifiers, InputMap dispatch engine
- [x] 02.3-02-PLAN.md -- Camera trait, FreeLookCamera, FpsCamera, CameraConfig extension
- [x] 02.3-03-PLAN.md -- TerminalGuard focus change, run.rs integration, prelude re-exports, model-viewer upgrade
...
Plans:
- [x] 02.5-01-PLAN.md -- STL loader + MeshError::StlParse + fixtures + tests + CI MSRV fix (Wave 1)
